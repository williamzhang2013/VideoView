...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    [MobClick beginLogPageView:@"RecentViewController"];
}

- (void)viewWillDisappear:(BOOL)animated
{
    [super viewWillDisappear:animated];
    [MobClick endLogPageView:@"RecentViewController"];
}
...
- (NSString *)requestUrl
{
    return @"http://api.videoshowapp.com:8087/api/v2/medium/recent.json";
}
